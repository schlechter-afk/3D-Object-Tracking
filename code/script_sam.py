"""Dense 3D Object Tracking Script via Space Carving and Segmentation-Aware 3D Object Detection"""
...
from dense_recon import DenseObjectReconstructor
...
for frame in range(1000, 1056, 8):
    ...
    xmin, ymin, zmin = np.min(intersection_mesh_vertices, axis=0)
    xmax, ymax, zmax = np.max(intersection_mesh_vertices, axis=0)
